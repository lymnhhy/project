                            ...
                            <div class="widget-content">
                                ...
                                <div class="single-blog-post d-flex align-items-center widget-post">
                                    ...
                                    <div class="post-thumbnail">
                                        <img src="img/protrack/12.jpg" alt="">
                                    </div>
                                    <!-- Post Content -->
                                    <div class="post-content">
                                        <a href="#" class="post-tag">ProTrack</a>
                                        <h4><a href="#" class="post-headline">Building Information Modeling (BIM) for Architecture</a></h4>
                                        <div class="post-meta">
                                            <p><a href="#">8 March</a></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="single-blog-post d-flex align-items-center widget-post">
                                    <!-- Post Thumbnail -->
                                    <div class="post-thumbnail">
                                        <img src="img/protrack/13.jpg" alt="">
                                    </div>
                                    <!-- Post Content -->
                                    <div class="post-content">
                                        <a href="#" class="post-tag">ProTrack</a>
                                ...
                                <div class="single-blog-post d-flex align-items-center widget-post">
                                    <!-- Post Thumbnail -->
                                    <div class="post-thumbnail">
                                        <img src="img/protrack/14.jpg" alt="">
                                    </div>
                                    <!-- Post Content -->
                                    <div class="post-content">
                                        <a href="#" class="post-tag">ProTrack</a>
                                ...
                                <div class="single-blog-post d-flex align-items-center widget-post">
                                    <!-- Post Thumbnail -->
                                    <div class="post-thumbnail">
                                        <img src="img/protrack/15.jpg" alt="">
                                    </div>
                                    <!-- Post Content -->
                                    <div class="post-content">
                                        <a href="#" class="post-tag">ProTrack</a>
